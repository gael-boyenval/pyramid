...
import styled from 'packages/gatsby-theme-pyramid-docs/src/gatsby-components/Do/node_modules/styled-components';
    ...
    .map((pattern, index) => {
      ...
      platforms.forEach((plateform) => {
        ...
        if (plateform === 'name') {
          ...
          thisPatternStatus.push(
            <td key={'value_row_' + plateform + index}>cross</td>,
          );
        }
      });
