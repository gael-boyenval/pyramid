  ...
  [2],
  {
    ...
    AbK1: function (e, t, n) {
      ...
      t.a = function (e) {
        ...
        function r(e, t, n, i) {
          ...
          if (944 === s) {
            ...
            return (
              ...
              1 === C || (2 === C && a(l, 1)) ? '-webkit-' + l + l : l
            );
          }
          if (0 === C || (2 === C && !a(o, 1))) return o;
          switch (s) {
            case 1015:
        ...
        function l(e, n) {
          ...
          var p = (function e(n, s, l, p, d) {
            for (
              ...
              if (
                ...
                if (
                  L === z &&
                  (0 < D && (U = U.replace(u, '')), 0 < U.trim().length)
                ) {
                  switch (g) {
                    case 32:
                    case 9:
                ...
                switch (g) {
                  ...
                  case 59:
                    if (
                      1 <
                      (B = (U = (0 < D ? U.replace(u, '') : U).trim()).length)
                    )
                      switch (
                        (0 === P &&
                          ((f = U.charCodeAt(0)),
                        ...
                        0 < R &&
                          void 0 !==
                            (E = o(1, U, s, n, _, N, G.length, p, d, p)) &&
                          0 === (B = (U = E.trim()).length) &&
                          (U = '\0\0'),
                        (f = U.charCodeAt(0)),
                        (g = U.charCodeAt(1)),
                ...
                case 10:
                  47 === x
                    ...
                    : 0 === 1 + f &&
                      ...
                      0 < U.length &&
                      ((D = 1), (U += '\0')),
                    0 < R * j && o(0, U, s, n, _, N, G.length, p, d, p),
                    (N = 1),
                    _++;
                  break;
                case 59:
            ...
            if (0 < (B = G.length)) {
              if (
                ((D = s),
                0 < R &&
                  void 0 !== (E = o(2, G, D, n, _, N, B, p, d, p)) &&
                  0 === (G = E).length)
              )
                return W + G + V;
              if (((G = D.join(',') + '{' + G + '}'), 0 != C * O)) {
                switch ((2 !== C || a(G, 2) || (O = 0), O)) {
                  case 111:
          ...
          return (
            0 < R &&
              void 0 !== (l = o(-2, p, s, s, _, N, p.length, 0, 0, 0)) &&
              (p = l),
            '',
            (O = 0),
            (N = _ = 1),
                      ...
                      if (!(E instanceof l)) {
                        ...
                        if (_) {
                          g && (h = _[1] ? _[1].length : 0),
                            (x =
                              (k = _.index + h) + (_ = _[0].slice(h)).length);
                          var C = E.slice(0, k),
                            T = E.slice(x),
                            I = [v, O];
                          C && (++v, (w += C.length), I.push(C));
                          var R = new l(c, f ? a.tokenize(_, f) : _, b, _, m);
                          if (
                            (I.push(R),
                            T && I.push(T),
                            Array.prototype.splice.apply(t, I),
                            1 != O && a.matchGrammar(e, t, n, v, w, !0, c),
                            o)
                          )
                            break;
                        } else if (o) break;
    ...
    LNZx: function (e, t, n) {
      ...
      if (n('q25y')) {
        var r = n('PZOW'),
          ...
          ge = C('iterator'),
          me = C('toStringTag'),
          he = O('typed_constructor'),
          be = O('def_constructor'),
          ye = s.CONSTR,
          ve = s.TYPED,
          we = s.VIEW,
          Ee = T(1, function (e, t) {
          ...
          je = {
            ...
            forEach: function (e) {
              H(Se(this), e, arguments.length > 1 ? arguments[1] : void 0);
            },
            indexOf: function (e) {
              return ne(
                Se(this),
          ...
          Pe = function (e, t) {
            return _e(this, pe.call(Se(this), e, t));
          },
          Le = function (e) {
            Se(this);
          ...
          Be = function (e, t) {
            return $e(e, (t = y(t, !0))) ? p(2, e[t]) : U(e, t);
          },
          Me = function (e, t, n) {
            return !($e(e, (t = y(t, !0))) && E(n) && v(n, 'value')) ||
              v(n, 'get') ||
              v(n, 'set') ||
              n.configurable ||
              ...
              ? ((g = n(function (e, n, r, a) {
                  ...
                  if (E(n)) {
                    if (
                      ...
                      return ve in n ? Oe(g, n) : Te.call(g, n);
                    (i = n), (f = Ae(r, t));
                    var b = n.byteLength;
                    if (void 0 === a) {
                    ...
                    s = o / t;
                  } else (s = h(n)), (i = new q((o = s * t)));
                  for (
                    d(e, '_d', { b: i, o: f, l: o, e: s, v: new Y(i) });
                    p < s;
      ...
      e.exports = function (e) {
        var t = e.scope,
          ...
          u = p.useMemo(
            function () {
              if (!a) return null;
              var e = c({ React: p, mdx: g }, l),
                t = Object.keys(e),
                n = t.map(function (t) {
                  return e[t];
                });
              return r(Function, ['_fn'].concat(o(t), ['' + a])).apply(
                void 0,
                [{}].concat(o(n)),
              );
            },
        ...
        return p.createElement(u, c({ components: s }, i));
      };
    },
    O94r: function (e, t, n) {
      var r;
    ...
    UK60: function (e, t, n) {
      ...
      var r = n('ERkP'),
        ...
        i = n('0yTM'),
        o = n('j/s1'),
        s = (n('Ly5D'), n('F0kF'), n('xXyX')),
        l = n('ZVZ0'),
        c = (n('/KhS'), n('O+tk')),
        u = n.n(c),
        p = (n('lw3w'), n('emEt').default.enqueue, a.a.createContext({}));
      function d(e) {
      ...
      n('sIWT'), n('l266'), n('0plx'), n('bIcM');
      var g = n('O94r'),
        m = n.n(g),
        h =
          (n('kF1u'),
          Object(o.b)(u.a).withConfig({
            ...
            function (e) {
              return (
                e.isPartOfCurrentlocation && Object(o.a)(['font-weight:600;'])
              );
            },
            function (e) {
              var t = e.level;
              return 1 === t
                ? Object(o.a)(['font-size:1.125rem;'])
                : 2 === t
                ? Object(o.a)(['font-size:1rem;color:#666;'])
                : 3 === t
                ? Object(o.a)(['font-size:0.875rem;color:#666;'])
                : void 0;
            },
          ),
          function (e) {
            var t = e.to,
              n = e.content,
              r = e.level,
              i = e.isPartOfCurrentlocation;
            return t
              ? a.a.createElement(
                  u.a,
                  {
                    to: t,
                    className: m()('c-menu-link', {
                      'c-menu-link--level-1': r - 1 == 1,
                      'c-menu-link--level-2': r - 1 == 2,
                      'c-menu-link--level-3': r - 1 >= 3,
                      'is-part-of-current-location': i,
                    }),
                  },
                  i
                    ? a.a.createElement('mark', null, n)
          ...
          return (
            ...
            (n.performEnter = function (e) {
              var t = this,
                ...
                a = this.props.nodeRef ? [r] : [N.a.findDOMNode(this), r],
                i = a[0],
                o = a[1],
                s = this.getTimeouts(),
            ...
            return (
              ...
              (n.buildMenu = function (e, t) {
                return (
                  ...
                  a.a.createElement(
                    'ul',
                    { className: m()('c-left-menu__group', { 'is-open': t }) },
                    e.map(function (e) {
                      return a.a.createElement(
                        'li',
                        { key: e.dirPath },
                          ...
                          e.content.length > 0 &&
                            a.a.createElement(
                              ...
                              a.a.createElement(
                                'svg',
                                {
                                  className: m()('c-left-menu__open-icon', {
                                    'is-open': e.isOpened,
          ...
          return (
            ...
            (r.prototype.render = function () {
              ...
              return a.a.createElement(
                ...
                e,
                t && a.a.createElement(M, null, 'copied'),
              );
            }),
            r
          );
      ...
      var U,
        ...
        W = o.b.div.withConfig({
          ...
          function (e) {
            var t = e.color;
            return t && Object(o.a)(['background:', ';'], t);
          },
        ),
          ...
          return (
            ...
            (r.prototype.render = function () {
              ...
              return a.a.createElement(
                V,
                null,
                a.a.createElement(W, { color: t }),
                a.a.createElement(z, {
                  value: t,
                  children: a.a.createElement(Y, { label: 'val', value: t }),
                }),
                a.a.createElement(z, {
                  value: n,
                  children: a.a.createElement(Y, { label: 'scss', value: n }),
                }),
                a.a.createElement(z, {
                  value: r,
                  children: a.a.createElement(Y, { label: 'ios', value: r }),
                }),
                a.a.createElement(z, {
                  value: i,
                  children: a.a.createElement(Y, { label: 'andr', value: i }),
                }),
                a.a.createElement(z, {
                  value: o,
                  children: a.a.createElement(Y, { label: 'es6', value: o }),
                }),
              );
            }),
            r
        ...
        Y = function (e) {
          ...
          return a.a.createElement(
            'span',
            null,
            a.a.createElement(X, null, a.a.createElement('span', null, t)),
            a.a.createElement('b', null, n),
          );
        },
        H = q,
        Z = o.b.div.withConfig({
        ...
        Q = function () {
          return a.a.createElement(
            K,
            null,
            a.a.createElement(Z, { key: 'tutu' }, 'COLOR'),
          );
        },
        J =
          (n('LJP+'),
          function (e) {
            ...
            return a.a.createElement(
              ...
              a.a.createElement('div', { className: 'c-do__content' }, t),
            );
          }),
        ee =
          (n('LAy0'),
      ...
      (te.a.languages.markup = {
        ...
        (te.a.languages.markup.tag.inside['attr-value'].inside.entity =
          te.a.languages.markup.entity),
        te.a.hooks.add('wrap', function (e) {
          'entity' === e.type &&
            (e.attributes.title = e.content.replace(/&amp;/, '&'));
        }),
        Object.defineProperty(te.a.languages.markup.tag, 'addInlined', {
          value: function (e, t) {
            var n = {};
            (n['language-' + t] = {
              pattern: /(^<!\[CDATA\[)[\s\S]+?(?=\]\]>$)/i,
              lookbehind: !0,
              inside: te.a.languages[t],
            }),
              (n.cdata = /^<!\[CDATA\[|\]\]>$/i);
            var r = {
              'included-cdata': {
            ...
            (a[e] = {
              ...
              te.a.languages.insertBefore('markup', 'cdata', a);
          },
        }),
        (te.a.languages.xml = te.a.languages.extend('markup', {})),
        (te.a.languages.html = te.a.languages.markup),
        (te.a.languages.mathml = te.a.languages.markup),
        (te.a.languages.svg = te.a.languages.markup),
        (function (e) {
          var t = {
            variable: [
              {
        ...
        (te.a.languages.c = te.a.languages.extend('clike', {
          'class-name': {
        ...
        te.a.languages.insertBefore('c', 'string', {
          macro: {
            pattern: /(^\s*)#\s*[a-z]+(?:[^\r\n\\]|\\(?:\r\n|[\s\S]))*/im,
            lookbehind: !0,
            alias: 'property',
        ...
        delete te.a.languages.c.boolean,
        (te.a.languages.cpp = te.a.languages.extend('c', {
          'class-name': {
        ...
        te.a.languages.insertBefore('cpp', 'string', {
          'raw-string': {
        ...
        (te.a.languages.css.selector = {
          pattern: te.a.languages.css.selector,
          inside: {
        ...
        te.a.languages.insertBefore('css', 'property', {
          variable: {
            pattern: /(^|[^-\w\xA0-\uFFFF])--[-_a-z\xA0-\uFFFF][-\w\xA0-\uFFFF]*/i,
            lookbehind: !0,
          },
        }),
        te.a.languages.insertBefore('css', 'function', {
        ...
        (te.a.languages.javascript = te.a.languages.extend('clike', {
          'class-name': [
            te.a.languages.clike['class-name'],
            {
        ...
        (te.a.languages.javascript[
          'class-name'
        ][0].pattern = /(\b(?:class|interface|extends|implements|instanceof|new)\s+)[\w.\\]+/),
        te.a.languages.insertBefore('javascript', 'keyword', {
          regex: {
            pattern: /((?:^|[^$\w\xA0-\uFFFF."'\])\s])\s*)\/(\[(?:[^\]\\\r\n]|\\.)*]|\\.|[^/\\\[\r\n])+\/[gimyu]{0,5}(?=\s*($|[\r\n,.;})\]]))/,
            lookbehind: !0,
            greedy: !0,
          ...
          parameter: [
            {
              ...
              lookbehind: !0,
              inside: te.a.languages.javascript,
            },
            {
        ...
        te.a.languages.insertBefore('javascript', 'string', {
          'template-string': {
            pattern: /`(?:\\[\s\S]|\${[^}]+}|[^\\`])*`/,
            greedy: !0,
            inside: {
              interpolation: {
                ...
                inside: {
                  ...
                  rest: te.a.languages.javascript,
                },
              },
              string: /[\s\S]+/,
            },
        ...
        te.a.languages.markup &&
          te.a.languages.markup.tag.addInlined('script', 'javascript'),
        (te.a.languages.js = te.a.languages.javascript),
        (function (e) {
        ...
        Object.defineProperty(G, 'addSupport', {
          value: function (e, t) {
            'string' == typeof e && (e = [e]),
              e.forEach(function (e) {
                !(function (e, t) {
                  ...
                  if (n) {
                    ...
                    if (!r) {
                      ...
                      r = (n = U.languages.insertBefore(e, 'comment', a))[
                        'doc-comment'
                      ];
                    }
                    if (
        ...
        G.addSupport(['java', 'javascript', 'php'], G),
        (function (e) {
        ...
        (te.a.languages.actionscript = te.a.languages.extend('javascript', {
          keyword: /\b(?:as|break|case|catch|class|const|default|delete|do|else|extends|finally|for|function|if|implements|import|in|instanceof|interface|internal|is|native|new|null|package|private|protected|public|return|super|switch|this|throw|try|typeof|use|var|void|while|with|dynamic|each|final|get|include|namespace|native|override|set|static)\b/,
          operator: /\+\+|--|(?:[+\-*\/%^]|&&?|\|\|?|<<?|>>?>?|[!=]=?)=?|[~?@]/,
        })),
        (te.a.languages.actionscript['class-name'].alias = 'function'),
        te.a.languages.markup &&
          te.a.languages.insertBefore('actionscript', 'string', {
            xml: {
              pattern: /(^|[^.])<\/?\w+(?:\s+[^\s>\/=]+=("|')(?:\\[\s\S]|(?!\2)[^\\])*\2)*\s*\/?>/,
              lookbehind: !0,
              inside: { rest: te.a.languages.markup },
            },
          }),
        (function (e) {
          var t = /#(?!\{).+/,
        ...
        (te.a.languages.n4js = te.a.languages.extend('javascript', {
          keyword: /\b(?:any|Array|boolean|break|case|catch|class|const|constructor|continue|debugger|declare|default|delete|do|else|enum|export|extends|false|finally|for|from|function|get|if|implements|import|in|instanceof|interface|let|module|new|null|number|package|private|protected|public|return|set|static|string|super|switch|this|throw|true|try|typeof|var|void|while|with|yield)\b/,
        })),
        te.a.languages.insertBefore('n4js', 'constant', {
          annotation: { pattern: /@+\w+/, alias: 'operator' },
        }),
        (te.a.languages.n4jsd = te.a.languages.n4js),
        (te.a.languages.typescript = te.a.languages.extend('javascript', {
          keyword: /\b(?:abstract|as|async|await|break|case|catch|class|const|constructor|continue|debugger|declare|default|delete|do|else|enum|export|extends|finally|for|from|function|get|if|implements|import|in|instanceof|interface|is|keyof|let|module|namespace|new|null|of|package|private|protected|public|readonly|return|require|set|static|super|switch|this|throw|try|type|typeof|var|void|while|with|yield)\b/,
          builtin: /\b(?:string|Function|any|number|boolean|Array|symbol|console|Promise|unknown|never)\b/,
        })),
        (te.a.languages.ts = te.a.languages.typescript),
        (te.a.languages.diff = {
          coord: [/^(?:\*{3}|-{3}|\+{3}).*$/m, /^@@.*@@$/m, /^\d+.*$/m],
          deleted: /^[-<].*$/m,
          inserted: /^[+>].*$/m,
        ...
        (te.a.languages.go = te.a.languages.extend('clike', {
        ...
        delete te.a.languages.go['class-name'],
        (te.a.languages.graphql = {
          comment: /#.*/,
          string: { pattern: /"(?:\\.|[^\\"\r\n])*"/, greedy: !0 },
        ...
        (te.a.languages.less = te.a.languages.extend('css', {
          comment: [
            /\/\*[\s\S]*?\*\//,
        ...
        te.a.languages.insertBefore('less', 'property', {
          variable: [
        ...
        (te.a.languages.markdown = te.a.languages.extend('markup', {})),
        te.a.languages.insertBefore('markdown', 'prolog', {
        ...
        ['bold', 'italic', 'strike'].forEach(function (e) {
          ['url', 'bold', 'italic', 'strike'].forEach(function (t) {
            e !== t &&
              (te.a.languages.markdown[e].inside[t] =
                te.a.languages.markdown[t]);
          });
        }),
        te.a.hooks.add('after-tokenize', function (e) {
        ...
        te.a.hooks.add('wrap', function (e) {
          if ('code-block' === e.type) {
            ...
            var o = te.a.languages[t];
            if (o) {
              var s = e.content.replace(/&lt;/g, '<').replace(/&amp;/g, '&');
              e.content = te.a.highlight(s, o, t);
            }
          }
        }),
        (te.a.languages.md = te.a.languages.markdown),
        (te.a.languages.objectivec = te.a.languages.extend('c', {
          keyword: /\b(?:asm|typeof|inline|auto|break|case|char|const|continue|default|do|double|else|enum|extern|float|for|goto|if|int|long|register|return|short|signed|sizeof|static|struct|switch|typedef|union|unsigned|void|volatile|while|in|self|super)\b|(?:@interface|@end|@implementation|@protocol|@class|@public|@protected|@private|@property|@try|@catch|@finally|@throw|@synthesize|@dynamic|@selector)\b/,
          string: /("|')(?:\\(?:\r\n|[\s\S])|(?!\1)[^\\\r\n])*\1|@"(?:\\(?:\r\n|[\s\S])|[^"\\\r\n])*"/,
          operator: /-[->]?|\+\+?|!=?|<<?=?|>>?=?|==?|&&?|\|\|?|[~^%?*\/@]/,
        })),
        delete te.a.languages.objectivec['class-name'],
        (te.a.languages.ocaml = {
          comment: /\(\*[\s\S]*?\*\)/,
          string: [
            { pattern: /"(?:\\.|[^\\\r\n"])*"/, greedy: !0 },
            {
        ...
        (te.a.languages.python[
          'string-interpolation'
        ].inside.interpolation.inside.rest = te.a.languages.python),
        (te.a.languages.py = te.a.languages.python),
        (te.a.languages.reason = te.a.languages.extend('clike', {
        ...
        te.a.languages.insertBefore('reason', 'class-name', {
          character: {
        ...
        delete te.a.languages.reason.function,
        (function (e) {
        ...
        (te.a.languages.scss = te.a.languages.extend('css', {
          comment: {
            pattern: /(^|[^\\])(?:\/\*[\s\S]*?\*\/|\/\/.*)/,
            lookbehind: !0,
          },
        ...
        te.a.languages.insertBefore('scss', 'atrule', {
          keyword: [
            /@(?:if|else(?: if)?|for|each|while|import|extend|debug|warn|mixin|include|function|return|content)/i,
            { pattern: /( +)(?:from|through)(?= )/, lookbehind: !0 },
          ],
        }),
        te.a.languages.insertBefore('scss', 'important', {
          variable: /\$[-\w]+|#\{\$[-\w]+\}/,
        }),
        te.a.languages.insertBefore('scss', 'function', {
        ...
        (te.a.languages.scss.atrule.inside.rest = te.a.languages.scss),
        (te.a.languages.sql = {
          comment: {
            pattern: /(^|[^\\])(?:\/\*[\s\S]*?\*\/|(?:--|\/\/|#).*)/,
            lookbehind: !0,
        ...
        (te.a.languages.yml = te.a.languages.yaml);
      var ne = te.a,
        re = n('RR6j'),
        ae = { Prism: ne, theme: n.n(re).a },
        ie = (n('0W7U'), /\r\n|\r|\n/),
        oe = function (e) {
          0 === e.length
          ...
          for (
            ...
            for (; (i = r[o]++) < a[o]; ) {
              ...
              if (
                ...
                for (var g = 1; g < f; g++)
                  oe(s), l.push((s = [])), s.push({ types: u, content: d[g] });
      ...
      var ue = function (e, t) {
        ...
        return (
          (a.root = n), (a.plain = ce({}, n, { backgroundColor: null })), a
        );
      };
      function pe() {
        return (pe =
      ...
      var fe = (function (e) {
          ...
          function r() {
            ...
            return (
              ...
              (t.getThemeDict = function (e) {
                ...
                var n = e.theme ? ue(e.theme, e.language) : void 0;
              ...
              (t.getLineProps = function (e) {
                var n = e.key,
                  ...
                  i =
                    (e.line,
                    pe({}, de(e, ['key', 'className', 'style', 'line']), {
                ...
                return (
                  ...
                  void 0 !== a &&
                    (i.style = void 0 !== i.style ? pe({}, i.style, a) : a),
                  void 0 !== n && (i.key = n),
                  r && (i.className += ' ' + r),
                  i
                );
              ...
              (t.getTokenProps = function (e) {
                var n = e.key,
                  ...
                  a = e.style,
                  i = e.token,
                  o = pe({}, de(e, ['key', 'className', 'style', 'token']), {
                ...
                return (
                  void 0 !== a &&
                    (o.style = void 0 !== o.style ? pe({}, o.style, a) : a),
                  void 0 !== n && (o.key = n),
                  r && (o.className += ' ' + r),
                  o
                );
        ...
        me = function (e) {
          ...
          return a.a.createElement(
            fe,
            Object.assign({}, ae, { code: t, language: n, theme: null }),
            function (e) {
              var t = e.className,
                n = e.tokens,
                i = e.getLineProps,
        ...
        he = function (e) {
          var t = e.children,
            ...
            c = l[0],
            u = l[1],
            p = i ? i.split('language-').pop().toLowerCase() : '',
            d = t.props && t.props.children ? t.props.children : t;
          return a.a.createElement(
            'div',
            { className: 'c-code' },
            s &&
              a.a.createElement('div', { className: 'c-code__file-name' }, s),
            a.a.createElement(
              'div',
              { className: 'c-code__wrapper' },
              d && a.a.createElement(me, { code: d, language: p, lines: o }),
              a.a.createElement(
                'button',
                {
      ...
      var be = o.b.code.withConfig({
          ...
          return (
            ...
            (r.prototype.render = function () {
              ...
              return a.a.createElement(
                ...
                { onClick: this.copyToClipBoard },
                e,
                t && a.a.createElement(ye, null, 'copied'),
              );
            }),
            r
          );
        })(a.a.Component),
        we = { info: 'Information', warning: 'Warning', tips: 'Useful tip' },
        Ee = o.b.div.withConfig({
          ...
          return 'info' === t
            ...
            : 'warning' === t
            ? Object(o.a)(['background-color:pink;border-left:solid 8px red;'])
            : 'tips' === t &&
              Object(o.a)([
                'background-color:lightblue;border-left:solid 8px deepskyblue;',
              ]);
        }),
        ke = o.b.div.withConfig({
          ...
          function (e) {
            var t = e.theme;
            return 'info' === t
              ? Object(o.a)(['color:#999;'])
              : 'warning' === t
              ? Object(o.a)(['color:orange;'])
              : 'tips' === t && Object(o.a)(['color:blue;']);
          },
        ),
        xe = o.b.div.withConfig({
        ...
        Ae = function (e) {
          ...
          return a.a.createElement(
            Ee,
            { theme: r },
            a.a.createElement(ke, { theme: r }, i || we[r]),
            a.a.createElement(xe, { theme: r }, t),
          );
        },
        Se = n('t5xW'),
        Ne =
              ...
              a.a.createElement(
                ...
                r &&
                  a.a.createElement(
                    ...
                    a.a.createElement('img', { src: r.node.publicURL, alt: i }),
                  ),
                a.a.createElement(
                  'p',
        ...
        _e = function (e) {
          ...
          return a.a.createElement(
            ...
            a.a.createElement('span', { className: 'subcontents__title' }, n),
            r &&
              a.a.createElement(
                'p',
                { className: 'subcontents__description' },
        ...
        Oe = function (e) {
          var t = e.siteMapData,
            ...
            r = e.location,
            i = /^\/|\/$/g,
            o = r.pathname.replace(i, '').split('/'),
            s = t,
            l = [];
          o.forEach(function (e) {
            l.push(e);
            var t = s.find(function (e) {
              return e.slug.replace(i, '') === l.join('/');
            });
          ...
          var c = (function e(t, n, r) {
            ...
            var i = t.map(function (t) {
              ...
              return r
                ...
                : a.a.createElement(
                    Ne,
                    { key: o, title: i, slug: o, thumbNail: c, description: l },
                    u,
                  );
            });
            return r
              ...
              : a.a.createElement('ul', null, i);
          })(s, n);
          return a.a.createElement('div', { className: 'subcontents' }, c);
        },
        Ce = function (e) {
          return a.a.createElement(f, {
            query: Ie,
        ...
        Te = function (e) {
          var t = v({ Component: Ce });
          return function (n) {
            return a.a.createElement(t, Object.assign({ location: e }, n));
          };
        },
        Ie = '1975076514',
        Re =
                    ...
                    o.map(function (e) {
                      ...
                      return a.a.createElement(
                        ...
                        a.a.createElement(
                          ...
                          r
                            ? a.a.createElement('mark', null, t)
                            : a.a.createElement(a.a.Fragment, null, t),
                        ),
                      );
                    }),
                  ),
      ...
      var je = function (e) {
          var t = e.children,
            n = e.className,
            r = Fe(e, ['children', 'className']);
          return a.a.createElement(
            'h1',
            Object.assign(
              { className: m()('t-heading-1', { className: n }) },
              r,
            ),
            t,
          );
        ...
        Pe = function (e) {
          ...
          return a.a.createElement(
            'h2',
            Object.assign(
              { className: m()('t-heading-2', { className: n }) },
              r,
            ),
            t,
          );
        ...
        Le = {
          ...
          h3: function (e) {
            ...
            return a.a.createElement(
              'h3',
              Object.assign(
                { className: m()('t-heading-3', { className: n }) },
                r,
              ),
              t,
            );
          ...
          h4: function (e) {
            ...
            return a.a.createElement(
              'h4',
              Object.assign(
                { className: m()('t-heading-4', { className: n }) },
                r,
              ),
              t,
            );
      ...
      var Me = o.b.span.withConfig({
        ...
        ze = function (e) {
          ...
          var r = (function (e) {
            if (!e) return e;
            var t = e.toLowerCase();
            return !!Be.includes(t) && t;
          })(t);
          return (
            !!r && a.a.createElement(Me, Object.assign({}, n, { status: r }), r)
          );
        };
      n('ya6z');
      function Ue(e) {
        ...
        function r() {
          ...
          return (
            ((t =
              ...
              var t = Ue(e)
                  .sort(function (e, t) {
                    return e.node.frontmatter.order - t.node.frontmatter.order;
                  })
                  .filter(function (e) {
                    return 'index' !== e.node.fields.fileName.name;
                  }),
                n = Ue(e).find(function (e) {
                  return 'index' === e.node.fields.fileName.name;
                });
              return [
                {
                  ...
                  status: n.node.frontmatter.status,
                },
              ].concat(
                Ue(
                  t.map(function (e) {
      ...
      var We = (function (e) {
        ...
        function r() {
          ...
          return (
            ((t =
              e.call.apply(e, [this].concat(r)) || this).scroller = function (
              e,
            ) {
              var t = e.hash;
              ...
              var n = document
                ...
                r = document.getElementById('scroller');
              r.scrollTop = n.y + r.scrollTop - 132;
            }),
            (t.onClick = function (e) {
              e.preventDefault();
              var n = e.target.hash;
              return t.scroller({ hash: n }), !1;
            }),
            (t.renderList = function (e) {
              return e.map(function (e, n) {
                ...
                o &&
                  (o = a.a.createElement(
                    'ul',
                    { className: 'c-toc__list', key: 'group_' + n },
                    t.renderList(o),
                  ));
                var s = !1;
                return (
                  i &&
                    ((i = (i = i.replace(/\{#([\w-]+)\}$/, function (e, t) {
                      return (r = '#' + t), '';
                    })).trim()),
                    (s = a.a.createElement(
                      'a',
                  ...
                  a.a.createElement(
                    'li',
                    { className: 'c-toc__list-item', key: r + '_link_' + n },
                    s,
                    o,
                  )
                );
        ...
        He =
          ((t.default = function (e) {
            var t = e.data,
              n = e.location,
              r = t.mdx,
              o = t.mdx.tableOfContents,
              s = Xe(t.allMdx.edges).filter(function (e) {
                var t = e.node;
                return (
                  ...
                  r.fields.fileName.relativePath.replace(
                    r.fields.fileName.base,
                    '',
                  )
                );
              }),
              ...
              p =
                (l.status,
                r.fields.slug && r.fields.slug.split('/'),
                s.length > 1);
            return a.a.createElement(
              De,
              { location: n, tableOfContents: o },
              a.a.createElement(
                'header',
                { className: 'c-page__header' },
                a.a.createElement(je, { className: 'c-page__main-heading' }, c),
                a.a.createElement(
                  'p',
                ...
                !p &&
                  ...
                  a.a.createElement(ze, { status: r.frontmatter.status }),
              ),
              a.a.createElement(
                Ye,
                null,
                a.a.createElement(
                  ...
                  p && a.a.createElement(Ve, { samePageTabs: s }),
                  a.a.createElement(
                    'div',
                    { className: 's-mdx' },
                    a.a.createElement(i.MDXRenderer, null, r.body),
                  ),
                ),
    ...
    Xjn8: function (e, t, n) {
      ...
      function U(e, t, n, r, a, i) {
        ...
        for (var s = e[C]._b, l = o + e[I], c = r(+a), u = 0; u < t; u++)
          s[l + u] = c[i ? u : t - u - 1];
      }
      if (o.ABV) {
        if (
    ...
    'j/s1': function (e, t, n) {
      ...
      (function (e) {
        ...
        var A = function (e) {
              ...
              if (o) {
                ...
                if (s) {
                  var l = 0 | parseInt(s[1], 10),
                    c = s[2];
                  0 !== l &&
                    (j(c, l), D(e, c, s[3]), e.getTag().insertRules(l, r)),
                    (r.length = 0);
                } else r.push(o);
              }
            }
          ...
          B = w,
          M = { isServer: !w, useCSSOMInjection: !E },
          z = (function () {
            function e(e, t, n) {
              void 0 === e && (e = M),
                void 0 === t && (t = {}),
        ...
        var X = i.a.createContext(),
          q = (X.Consumer, i.a.createContext()),
          Y = (q.Consumer, new z()),
          H = W();
        function Z() {
          return Object(a.useContext)(X) || Y;
        }
        function K() {
            ...
            function e(e, t) {
              ...
              (this.inject = function (e) {
                e.hasNameForId(n.id, n.name) ||
                  e.insertRules(n.id, n.name, H.apply(void 0, n.stringifyArgs));
              }),
...
//# sourceMappingURL=component---src-templates-pattern-page-tsx-f5f6ae03d7ffc34d24d2.js.map
