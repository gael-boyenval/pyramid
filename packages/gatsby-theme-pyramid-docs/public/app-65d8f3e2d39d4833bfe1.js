      ...
      n('Y1td')('replace', 2, function (t, e, n, d) {
        return [
          ...
          function (t, e) {
            ...
            for (var w, O = '', _ = 0, P = 0; P < y.length; P++) {
              b = y[P];
              for (
                var S = String(b[0]),
              ...
              var R = b.groups;
              if (h) {
                var k = [S].concat(E, j, p);
                void 0 !== R && k.push(R);
                var C = String(e.apply(void 0, k));
              } else C = v(S, p, j, E, R, e);
              j >= _ && ((O += p.slice(_, j) + C), (_ = j + S.length));
            }
            return O + p.slice(_);
          },
        ];
          ...
          [
            ...
            function (t, e) {
              ...
              for (var w = 0, O = 0, _ = []; O < p.length; ) {
                ...
                if (
                  null === S ||
                  (P = f(c(y.lastIndex + (d ? 0 : O)), p.length)) === w
                )
                  O = a(p, O, g);
                else {
          ...
          (function t(e) {
            ...
            (n.create = function (t) {
              ...
              (n.registerLanguage = function (t, e) {
                return (S[t] = e.filter), (j[t] = e.stemmer), this;
              }),
                  ...
                  for (
                    ...
                    if (b) {
                      ...
                      switch (n) {
                        ...
                        case 'forward':
                          for (S = 0; S < w; S++)
                            c(f, u, (_ += b[S]), t, m ? (S + 1) / w : 1, O, s);
                          break;
                        case 'full':
                          for (S = 0; S < w; S++)
                            for (
                              var j = (m ? S + 1 : w - S) / w, E = w;
                              E > S;
                              E--
                            )
                              c(f, u, (_ = b.substring(S, E)), t, j, O, s);
                          break;
                        default:
                          if (
              ...
              (n.prototype.search = function (t, e, n, r) {
                ...
                if (
                  ...
                  r = (n = h((n = this.b)) ? n(i) : i.split(P)).length;
                  var u,
                    s = !0,
                    d = [],
                    v = g();
                        ...
                        if (!v[w]) {
                          ...
                          if ((y = m ? u[y] : this.f))
                            for (var j = void 0, E = 0; E < 10 - o; E++)
                              (j = y[E][w]) && ((O[S++] = j), (_ = !0));
                          if (_)
                            d[d.length] = 1 < S ? O.concat.apply([], O) : O[0];
                          else if (!this.u) {
                            s = !1;
                            break;
                          }
        ...
        V = function (t, e, n) {
          return (
            ...
            o(q, e)
              ? (n.enumerable
                  ? (o(t, U) && t[U][e] && (t[U][e] = !1),
                    (n = S(n, { enumerable: P(0, !1) })))
                  : (o(t, U) || D(t, U, P(1, {})), (t[U][e] = !0)),
                z(t, e, n))
              : D(t, e, n)
          );
        },
...
//# sourceMappingURL=app-65d8f3e2d39d4833bfe1.js.map
